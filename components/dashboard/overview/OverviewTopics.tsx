...
export default function OverviewTopics({ topics }: Props) {
  return (
    <div className="bg-[#1A1A1A] border border-white/5 rounded-xl p-5 h-full flex flex-col">
      <h3 className="text-white font-bold text-lg mb-3">Temas Dominantes</h3>
      {topics.length === 0 ? (
        ...
        // Altura fixa + scroll (não h-full/flex-1) para manter a mesma altura
        // dos outros 3 cards do Panorama Analítico, mesmo com muitos temas.
