  ...
  return (
    <div className="glass h-[254px] rounded-2xl p-4 flex flex-col">
      ...
      <div className="flex flex-col items-center">
        <div className="w-full h-[132px] -my-1">
          <ReactECharts option={option} style={{ height: '100%', width: '100%' }} />
        </div>

        <div className="text-gray-400 text-[10px] font-medium -mt-2 mb-2 uppercase tracking-widest opacity-60">
          Risco Consolidado
        </div>

        <div className="w-full grid grid-cols-3 gap-2">
          <div className="bg-white/5 rounded-lg px-2 py-1.5 border border-white/5 text-center">
