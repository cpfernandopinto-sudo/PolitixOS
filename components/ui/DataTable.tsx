  ...
  return (
    <div className="w-full overflow-x-auto rounded-xl border border-white/5 glass">
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-white/5 bg-[#12192A]/50">
            ...
            <th className="p-4 text-xs font-medium text-gray-400 uppercase tracking-wider">Ação</th>
          </tr>
        </thead>
      ...
      <div className="p-4 border-t border-white/5 flex items-center justify-between bg-[#12192A]/30">
        <span className="text-xs text-gray-500">Mostrando 1 a 5 de 1245 resultados</span>
        <div className="flex gap-2">
          <button className="px-3 py-1 rounded bg-[#0D0D0D] border border-white/10 text-xs text-gray-400 hover:text-white transition-colors" disabled>Anterior</button>
          <button className="px-3 py-1 rounded bg-[#2563EB] text-xs text-white shadow-[0_0_10px_rgba(37,99,235,0.3)]">1</button>
          <button className="px-3 py-1 rounded bg-[#0D0D0D] border border-white/10 text-xs text-gray-400 hover:text-white transition-colors">2</button>
          <button className="px-3 py-1 rounded bg-[#0D0D0D] border border-white/10 text-xs text-gray-400 hover:text-white transition-colors">3</button>
          <button className="px-3 py-1 rounded bg-[#0D0D0D] border border-white/10 text-xs text-gray-400 hover:text-white transition-colors">Próxima</button>
        </div>
      </div>
    </div>
  );
